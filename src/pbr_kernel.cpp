...
float enterpriseApproxAverageAlbedoGGX_0(float alpha_0)
{
    ...
    float roughness_0 = sqrt(max(alpha_0, 0.0f));
    return clamp(1.0f - 0.57999998331069946f * roughness_0 + 0.07999999821186066f * roughness_0 * roughness_0, 0.0f, 1.0f);
}


float enterpriseApproxAverageAlbedoGGXMs_0(float alpha_1, float e0_0)
{
    return clamp(clamp(e0_0 + (1.0f - e0_0) * 0.0476190485060215f, 0.0f, 1.0f) * enterpriseApproxAverageAlbedoGGX_0(alpha_1), 0.0f, 1.0f);
}
...
float enterpriseApproxDirectionalAlbedoGGX_0(float alpha_4, float cosTheta_0)
{
    ...
    return clamp(1.0f - sqrt(max(alpha_4, 0.0f)) * (0.5f + 0.5f * powf_(1.0f - clamp(cosTheta_0, 0.0f, 1.0f), 5.0f)), 0.0f, 1.0f);
}
...
float enterpriseApproxDirectionalAlbedoGGXMs_0(float theta_0, float alpha_5, float e0_3)
{
    ...
    float noV_0 = clamp(theta_0, 0.0f, 1.0f);


    return clamp(clamp(e0_3 + (1.0f - e0_3) * powf_(1.0f - noV_0, 5.0f), 0.0f, 1.0f) * mix(1.0f, enterpriseApproxDirectionalAlbedoGGX_0(alpha_5, noV_0), 0.64999997615814209f), 0.0f, 1.0f);
}
...
GltfPbrMaterial_0 defaultGltfPbrMaterial_0()
{
    ...
    material_0.baseColorFactor_0 = Vec4(1.0f);
    material_0.metallicFactor_0 = 1.0f;
    material_0.roughnessFactor_0 = 1.0f;
    const Vec3 _S1 = Vec3(0.0f);

    material_0.emissiveFactor_0 = _S1;
    material_0.emissiveStrength_0 = 1.0f;

    material_0.specularFactor_0 = 1.0f;
    const Vec3 _S2 = Vec3(1.0f);

    material_0.specularColorFactor_0 = _S2;

    material_0.transmissionFactor_0 = 0.0f;
    material_0.diffuseTransmissionFactor_0 = 0.0f;
    material_0.diffuseTransmissionColorFactor_0 = _S2;
    material_0.ior_0 = 1.5f;
    material_0.attenuationColor_0 = _S2;
    material_0.attenuationDistance_0 = 1.00000002004087734e+20f;
    material_0.thicknessFactor_0 = 0.0f;
    material_0.multiscatterColorFactor_0 = _S1;
    material_0.scatterAnisotropy_0 = 0.0f;

    material_0.clearcoatFactor_0 = 0.0f;
    material_0.clearcoatRoughnessFactor_0 = 0.0f;
    material_0.clearcoatNormalTextureScale_0 = 1.0f;

    material_0.sheenColorFactor_0 = _S1;
    material_0.sheenRoughnessFactor_0 = 0.0f;

    material_0.anisotropyStrength_0 = 0.0f;
    material_0.anisotropyRotation_0 = 0.0f;

    material_0.iridescenceFactor_0 = 0.0f;
    material_0.iridescenceIor_0 = 1.29999995231628418f;
    material_0.iridescenceThickness_0 = 400.0f;

    material_0.dispersion_0 = 0.0f;

    material_0.normalTextureScale_0 = 1.0f;
...
SurfaceMaterial_0 buildEnterpriseSurfaceFromGltf_0(GltfPbrMaterial_0 material_2)
{
    ...
    const Vec3 _S4 = Vec3(0.0f);

    const Vec3 _S5 = Vec3(1.0f);

    surface_0.albedo_0 = clamp(material_2.baseColorFactor_0.xyz(), _S4, _S5);
    surface_0.metallic_0 = clamp(material_2.metallicFactor_0, 0.0f, 1.0f);
    surface_0.roughness_1 = clamp(material_2.roughnessFactor_0, 0.0f, 1.0f);
    surface_0.anisotropy_0 = clamp(material_2.anisotropyStrength_0, 0.0f, 1.0f);
    surface_0.anisotropyDirection_0 = Vec3(cos(material_2.anisotropyRotation_0), sin(material_2.anisotropyRotation_0), 0.0f);
    surface_0.transparency_0 = clamp(material_2.transmissionFactor_0, 0.0f, 1.0f);
    surface_0.ior_1 = max(material_2.ior_0, 1.0f);
    surface_0.specularColor_0 = clamp(material_2.specularColorFactor_0, _S4, _S5);
    surface_0.specular_0 = clamp(material_2.specularFactor_0, 0.0f, 1.0f);
    ...
    surface_0.attenuationColor_1 = max(material_2.attenuationColor_0, Vec3(0.00009999999747379f));
    surface_0.attenuationDistance_1 = max(material_2.attenuationDistance_0, 0.00009999999747379f);
    surface_0.multiscatterColor_0 = clamp(material_2.multiscatterColorFactor_0, _S4, _S5);
    surface_0.scatterAnisotropy_1 = clamp(material_2.scatterAnisotropy_0, -0.99900001287460327f, 1.0f);

    float _S6;
    if((material_2.thicknessFactor_0) > 0.0f)
    {
    ...
    surface_0.translucency_0 = clamp(material_2.diffuseTransmissionFactor_0, 0.0f, 1.0f);
    surface_0.translucencyColor_0 = clamp(material_2.diffuseTransmissionColorFactor_0, _S4, _S5);
    surface_0.iridescence_0 = clamp(material_2.iridescenceFactor_0, 0.0f, 1.0f);
    surface_0.iridescenceIor_1 = clamp(material_2.iridescenceIor_0, 1.0f, 2.5f);
    surface_0.iridescenceThickness_1 = max(material_2.iridescenceThickness_0, 0.0f);
    surface_0.dispersion_1 = max(material_2.dispersion_0, 0.0f);
    surface_0.clearcoat_0 = clamp(material_2.clearcoatFactor_0, 0.0f, 1.0f);
    surface_0.clearcoatRoughness_0 = clamp(material_2.clearcoatRoughnessFactor_0, 0.0f, 1.0f);
    surface_0.sheenColor_0 = clamp(material_2.sheenColorFactor_0, _S4, _S5);
    surface_0.sheenRoughness_0 = clamp(material_2.sheenRoughnessFactor_0, 0.0f, 1.0f);
    surface_0.clearcoatNormalScale_0 = material_2.clearcoatNormalTextureScale_0;
    surface_0.frontFaceEmissionOnly_0 = 0.0f;
    return surface_0;
}
...
Vec3 clamp01_0(Vec3 v_0)
{
    ...
    return clamp(v_0, Vec3(0.0f), Vec3(1.0f));
}
...
Vec3 schlickAverageWeight_0(Vec3 f0_0, Vec3 f90_0)
{
    ...
    return f0_0 + (f90_0 - f0_0) * 0.0476190485060215f;
}
...
float materialRoughnessForBsdf_0(float roughness_2)
{
    ...
    return clamp(max(roughness_2, 0.0020000000949949f), 0.0f, 1.0f);
}
...
float iridescenceInterfaceWeight_0(float iridescence_1, float filmIor_0)
{
    ...
    float _S8 = max(filmIor_0, 1.0f);

    return clamp(iridescence_1, 0.0f, 1.0f) * powf_((_S8 - 1.0f) / max(_S8 + 1.0f, 0.00000999999974738f), 2.0f);
}
...
SurfaceClosure_0 buildSurfaceClosure_0(SurfaceMaterial_0 surface_1, SurfaceLayerNormals_0 layerNormals_0, Vec3 anisotropyTangent_2)
{
    ...
    float dielectricWeight_1 = 1.0f - surface_1.metallic_0;

    float _S9 = 1.0f - surface_1.transparency_0;
    ...
    closure_0.clearcoatWeight_0 = surface_1.clearcoat_0 * mix(0.20000000298023224f, 1.0f, 1.0f - clearcoatRoughness_2);
...
MaterialBsdfState_0 prepareMaterialBsdfState_0(SurfaceMaterial_0 surface_3, SurfaceClosure_0 closure_2, TransportContext_0 transportContext_0)
{
    ...
    state_0.currentMediumIor_0 = max(transportContext_0.currentMediumIor_1, 1.0f);
    return state_0;
}
...
{
    return closure_4.diffuseTransmissionColor_0 * 0.31830987334251404f * max(abs(dot(normal_0, lightDir_0)), 0.0f);
}
...
Vec2 anisotropicAlpha_0(float roughness_4, float anisotropy_2)
{
    ...
    float clampedAnisotropy_0 = clamp(anisotropy_2, 0.0f, 1.0f);
    float _S11 = max(roughness_4 * roughness_4, 0.0f);

    return Vec2(mix(_S11, 1.0f, clampedAnisotropy_0 * clampedAnisotropy_0), _S11);
}
...
float ggxDistributionAnisotropic_0(Vec2 alpha_12, Vec3 localH_0)
{
    ...
    return 1.0f / max(3.14159274101257324f * _S12 * _S13 * denom_0 * denom_0, 9.999999960041972e-13f);
}
...
float ggxSmithLambdaAnisotropic_0(Vec2 alpha_13, Vec3 localDir_0)
{
    ...
    if(cosTheta2_0 <= 9.99999993922529029e-09f)
    {

        return 0.0f;
    }

    if((max(1.0f - cosTheta2_0, 0.0f)) <= 9.99999993922529029e-09f)
    {
    ...
    return 0.5f * (-1.0f + sqrt(1.0f + (_S16 * _S16 * _S17 * _S17 + _S18 * _S18 * _S19 * _S19) / max(cosTheta2_0, 9.99999993922529029e-09f)));
}

float ggxSmithG2Anisotropic_0(Vec2 alpha_14, Vec3 localView_0, Vec3 localLight_0)
{

    return 1.0f / (1.0f + ggxSmithLambdaAnisotropic_0(alpha_14, localView_0) + ggxSmithLambdaAnisotropic_0(alpha_14, localLight_0));
}
...
Vec3 evaluateMicrofacetResponseAnisotropic_0(float roughness_5, float anisotropy_3, Vec3 normal_2, Vec3 tangent_1, Vec3 viewDir_0, Vec3 lightDir_1)
{
    ...
    float _S20 = max(dot(viewDir_0, halfVec_0), 0.0f);
    ...
    return Vec3(ggxDistributionAnisotropic_0(alpha_15, localHalf_0) * ggxSmithG2Anisotropic_0(alpha_15, localView_1, localLight_1) / max(4.0f * noV_1 * noL_0, 0.00000999999974738f));
}
...
DielectricFresnelAngles_0 dielectricFresnelAngles_0(float cosTheta_4, float ni_0, float nt_0, bool thinWalled_3)
{
    ...
    float cosI_0 = clamp(cosTheta_4, 0.0f, 1.0f);
    float eta_0 = ni_0 / max(nt_0, 0.00000999999974738f);
    float sinT2_0 = eta_0 * eta_0 * max(1.0f - cosI_0 * cosI_0, 0.0f);
    ...
    if(_S22)
    {
        ...
        result_0.schlickCosTheta_0 = 0.0f;
        result_0.totalInternalReflection_0 = true;
        return result_0;
    }
    float cosT_0 = sqrt(max(1.0f - sinT2_0, 0.0f));
    if(nt_0 >= ni_0)
    {
...
Vec3 fresnelSchlick_0(Vec3 f0_1, Vec3 f90_1, float cosTheta_5)
{
    ...
    float m_0 = clamp(1.0f - cosTheta_5, 0.0f, 1.0f);
    float m2_0 = m_0 * m_0;
...
Vec3 fresnelSchlickDielectric_0(float cosTheta_6, Vec3 f0_2, Vec3 f90_2, float ni_1, float nt_1, bool thinWalled_4)
{
    ...
    if((abs(ni_1 - nt_1)) <= 0.00009999999747379f)
    {
...
float thinFilmIorToFresnel0_0(float transmittedIor_0, float incidentIor_0)
{
    ...
    float ratio_0 = (transmittedIor_0 - incidentIor_0) / max(transmittedIor_0 + incidentIor_0, 0.00000999999974738f);
...
Vec3 thinFilmDielectricSubstrateF0_0(float ior_3, float outsideIor_0)
{
    ...
    return Vec3(thinFilmIorToFresnel0_0(max(ior_3, 1.0f), max(outsideIor_0, 1.0f)));
}

Vec3 thinFilmFresnel0ToIor_0(Vec3 f0_3)
{

    Vec3 sqrtF0_0 = sqrt(clamp(f0_3, Vec3(0.0f), Vec3(0.99989998340606689f)));
    const Vec3 _S25 = Vec3(1.0f);

    return (_S25 + sqrtF0_0) / max(_S25 - sqrtF0_0, Vec3(0.00000999999974738f));
}

Vec3 thinFilmSensitivity_0(float opdNm_0, Vec3 shift_0)
{

    float phase_0 = 6.28318548202514648f * opdNm_0 * 9.99999971718068537e-10f;
    float phase2_0 = phase_0 * phase_0;


    const Vec3 variance_0 = Vec3(4.327799808e+09f, 9.304599552e+09f, 6.612100096e+09f);
    Vec3 xyz_0 = Vec3(5.48560003844900113e-13f, 4.42010008238832852e-13f, 5.24810013155518895e-13f) * sqrt(6.28318548202514648f * variance_0) * cos(Vec3(1.681e+06f, 1.7953e+06f, 2.2084e+06f) * phase_0 + shift_0) * exp(- phase2_0 * variance_0);
    xyz_0[0] = xyz_0[0] + 9.74699989231449238e-14f * sqrt(2.845152256e+10f) * cos(2.2399e+06f * phase_0 + shift_0.x) * exp(-4.528200192e+09f * phase2_0);
    Vec3 _S26 = xyz_0 / 1.06850002623559703e-07f;
    ...
    return Vec3(3.24045419692993164f * _S27 - 1.53713846206665039f * _S28 - 0.49853140115737915f * _S29, -0.96926599740982056f * _S27 + 1.87601077556610107f * _S28 + 0.04155600070953369f * _S29, 0.05564339831471443f * _S27 - 0.20402589440345764f * _S28 + 1.05722522735595703f * _S29);
}
...
Vec3 thinFilmReflectance_0(float outsideIor_1, float filmIor_1, Vec3 baseF0_0, float thicknessNm_0, float cosTheta1_0)
{
    ...
    float safeFilmIor_0 = clamp(filmIor_1, 1.0f, 2.5f);
    float safeCosTheta1_0 = clamp(cosTheta1_0, 0.0f, 1.0f);

    float cosTheta2Sq_0 = 1.0f - outsideIor_1 / safeFilmIor_0 * (outsideIor_1 / safeFilmIor_0) * (1.0f - safeCosTheta1_0 * safeCosTheta1_0);
    if(cosTheta2Sq_0 < 0.0f)
    {
    ...
    float phi21_0 = 3.14159274101257324f - phi12_0;
    ...
    Vec3 r123_0 = clamp(_S37 * r23_0, _S32, Vec3(0.99989998340606689f));
    ...
    for(;;)
    {
        ...
        Vec3 reflectance_1 = reflectance_0 + cm_1 * 2.0f * thinFilmSensitivity_0(_S41 * _S33, _S41 * _S36);
    ...
    return max(reflectance_0, Vec3(0.0f));
}

Vec3 thinFilmMixFresnel_0(Vec3 regularF_0, Vec3 filmF_0, float iridescence_3)
{

    return mix(regularF_0, filmF_0, Vec3(clamp(iridescence_3, 0.0f, 1.0f)));
}
...
Vec3 thinFilmDielectricFresnel_0(SurfaceClosure_0 closure_6, float cosTheta_7, Vec3 regularF_1, float incidentIor_1)
{
    ...
    if((closure_6.iridescence_2) <= 0.00000999999974738f)
    {

        return regularF_1;
    }
    return thinFilmMixFresnel_0(regularF_1, thinFilmReflectance_0(max(incidentIor_1, 1.0f), closure_6.iridescenceIor_2, thinFilmDielectricSubstrateF0_0(closure_6.ior_2, incidentIor_1), closure_6.iridescenceThickness_2, cosTheta_7), closure_6.iridescence_2);
}
...
Vec3 fresnelSchlickAverage_0(Vec3 f0_4, Vec3 f90_3)
{
    ...
    return f0_4 + (f90_3 - f0_4) * 0.0476190485060215f;
}
...
Vec3 evaluateDielectricSpecularGGX_0(SurfaceClosure_0 closure_7, Vec3 normal_3, Vec3 viewDir_1, Vec3 lightDir_2, float iorI_0, float iorO_0)
{
    ...
    float _S42 = max(dot(normal_3, lightDir_2), 0.0f);
    ...
    float _S44 = max(dot(viewDir_1, normalize(viewDir_1 + lightDir_2)), 0.0f);
    float _S45 = max(closure_7.roughness_3 * closure_7.roughness_3, 0.0f);



    float eAvg_0 = averageAlbedoGGX_0(_S45);
    float _S46 = 1.0f - eAvg_0;

    float ms_0 = (1.0f - directionalAlbedoGGX_0(_S45, _S42)) * (1.0f - directionalAlbedoGGX_0(_S45, abs(dot(normal_3, viewDir_1)))) / max(3.14159274101257324f * _S46, 9.99999997475242708e-07f);
    ...
    if((closure_7.iridescence_2) > 0.00000999999974738f)
    {

        _S43 = iorI_0 <= 1.00010001659393311f;
    ...
    if(_S43)
    {
        ...
        f_0 = thinFilmDielectricFresnel_0(closure_7, _S44, regularF_2, 1.0f);
    ...
    if((abs(iorI_0 - iorO_0)) <= 0.00009999999747379f)
    {
    ...
    return transparentWeight_0 * (microfacetResponse_0 * f_0 + ms_0 * (fAvg_0 * fAvg_0 * eAvg_0 / max(Vec3(1.0f) - fAvg_0 * _S46, Vec3(0.00000999999974738f)))) * _S42;
}
...
Vec2 reflectionTransmissionProbabilities_0(Vec3 throughput_1, Vec3 reflectionCoeff_0, Vec3 transmissionCoeff_0)
{
    ...
    if(totalWeight_0 <= 0.00000999999974738f)
    {
...
DielectricTransmissionCoefficients_0 computeDielectricTransmissionCoefficients_0(SurfaceClosure_0 closure_9, float currentMediumIor_2, Vec3 baseNormal_0, Vec3 viewDir_2, float iorI_1, float iorO_1)
{
    ...
    float _S48 = max(dot(baseNormal_0, viewDir_2), 0.00000999999974738f);
    ...
    if((closure_9.iridescence_2) > 0.00000999999974738f)
    {

        _S49 = iorI_1 <= 1.00010001659393311f;
    ...
    if(_S49)
    {
        ...
        filmReflect_0 = thinFilmDielectricFresnel_0(closure_9, _S48, fresnelReflect_0, 1.0f);
    ...
    Vec3 transmissionCoeff_2 = (Vec3(1.0f) - filmReflect_0) * weightedTransmissionColor_1(closure_9);

    Vec2 probs_0 = reflectionTransmissionProbabilities_0(max(closure_9.throughput_0, Vec3(max(currentMediumIor_2, 0.00000999999974738f))), reflectionCoeff_2, transmissionCoeff_2);
...
Vec3 flipAcrossNormal_0(Vec3 v_2, Vec3 n_0)
{
    ...
    return normalize(v_2 - 2.0f * n_0 * dot(v_2, n_0));
}
...
Vec3 evaluateThinTransmissionScattering_0(SurfaceClosure_0 closure_10, Vec3 normal_4, Vec3 viewDir_3, Vec3 lightDir_3, float iorI_2, float iorO_2)
{
    ...
    if((dot(normal_4, viewDir_3) * _S50) >= 0.0f)
    {
    ...
    float _S51 = max(dot(viewDir_3, normalize(viewDir_3 + mirroredLightDir_0)), 0.00000999999974738f);
    ...
    if((closure_10.iridescence_2) > 0.00000999999974738f)
    {

        _S52 = iorI_2 <= 1.00010001659393311f;
    ...
    if(_S52)
    {
        ...
        filmReflect_1 = thinFilmDielectricFresnel_0(closure_10, _S51, regularReflect_0, 1.0f);
    ...
    return weightedTransmissionColor_1(closure_10) * (Vec3(1.0f) - filmReflect_1) * evaluateMicrofacetResponseAnisotropic_0(closure_10.roughness_3, closure_10.anisotropy_1, normal_4, closure_10.anisotropyTangent_1, viewDir_3, mirroredLightDir_0) * abs(_S50);
}
...
Vec3 evaluateThickTransmissionScattering_0(SurfaceClosure_0 closure_11, Vec3 transmissionCoeff_3, Vec3 normal_5, Vec3 viewDir_4, Vec3 lightDir_4, float iorI_3, float iorO_3)
{
    ...
    else
    {
        ...
        _S53 = noL_1 <= 0.00000999999974738f;
    ...
    else
    {
        ...
        _S53 = (dot(normal_5, viewDir_4) * dot(normal_5, lightDir_4)) >= 0.0f;
    ...
    float etaRatio_0 = iorO_3 / max(iorI_3, 0.00000999999974738f);
    ...
    if((abs(localHalf_1.z)) <= 0.00000999999974738f)
    {
    ...
    float factor_0 = etaRatio_0 * etaRatio_0 * _S54 * abs(loH_0) / max(powf_(voH_0 + etaRatio_0 * loH_0, 2.0f) * noV_2, 0.00000999999974738f);
    ...
    if((closure_11.iridescence_2) > 0.00000999999974738f)
    {

        _S53 = iorI_3 <= 1.00010001659393311f;
    ...
    if(_S53)
    {
        ...
        effectiveTransmissionCoeff_0 = (Vec3(1.0f) - thinFilmDielectricFresnel_0(closure_11, _S54, regularReflect_1, 1.0f)) * weightedTransmissionColor_1(closure_11);
...
Vec3 dispersionIors_0(SurfaceClosure_0 closure_12)
{
    ...
    float _S55 = max(closure_12.ior_2, 1.0f);

    float scale_0 = (_S55 - 1.0f) * max(closure_12.dispersion_2, 0.0f) * 0.05000000074505806f;



    return max(Vec3(_S55 + scale_0 * -0.30094969272613525f, _S55, _S55 + scale_0 * 0.69905030727386475f), Vec3(1.0f));
}
...
Vec3 evaluateThickTransmissionScatteringDispersed_0(SurfaceClosure_0 closure_13, Vec3 transmissionCoeff_4, Vec3 normal_6, Vec3 viewDir_5, Vec3 lightDir_5, float iorI_4, float iorO_4, bool insideMedium_0)
{
    ...
    bool _S56;
    if((closure_13.dispersion_2) <= 0.00000999999974738f)
    {
    ...
    else
    {
        ...
        _S56 = (closure_13.thinWalled_1) > 0.5f;
    ...
    Vec3 _S57 = Vec3(transmissionCoeff_4.x, 0.0f, 0.0f);
    ...
    Vec3 _S60 = Vec3(0.0f, transmissionCoeff_4.y, 0.0f);
    ...
    Vec3 _S61 = Vec3(0.0f, 0.0f, transmissionCoeff_4.z);
...
Vec3 evalDielectricTransmission_0(SurfaceClosure_0 closure_14, float currentMediumIor_3, Vec3 normal_7, Vec3 viewDir_6, Vec3 lightDir_6)
{
    ...
    float _S62 = max(currentMediumIor_3, 1.0f);

    bool insideMedium_1;
    if(_S62 > 1.00010001659393311f)
    {

        insideMedium_1 = (closure_14.thinWalled_1) < 0.5f;
    ...
    if((dot(normal_7, viewDir_6) * dot(normal_7, lightDir_6)) > 0.0f)
    {
    ...
    if((closure_14.thinWalled_1) > 0.5f)
    {
...
float coupledDiffuseFactor_0(SurfaceClosure_0 closure_15, float noV_3, float noL_2)
{
    ...
    float _S65 = max(_S64 * _S64, 0.0f);
    float e0_8 = max3_0(closure_15.dielectricSpecularColor_0 * closure_15.dielectricWeight_0);

    return mix(0.31830987334251404f, (1.0f - directionalAlbedoGGXMs_0(noL_2, _S65, e0_8)) * (1.0f - directionalAlbedoGGXMs_0(noV_3, _S65, e0_8)) / max(3.14159274101257324f * (1.0f - averageAlbedoGGXMs_0(_S65, e0_8)), 9.99999997475242708e-07f), closure_15.specular_1);
}
...
Vec3 closureDiffuseEnergy_0(SurfaceClosure_0 closure_18)
{
    ...
    const Vec3 _S66 = Vec3(1.0f);

    return clamp(_S66 - (fresnelSchlickAverage_0(closure_18.specularColor_1, closure_18.specularF90_0) * closure_18.metallic_1 + fresnelSchlickAverage_0(closure_18.dielectricSpecularColor_0, closure_18.dielectricSpecularF90_0) * closure_18.dielectricWeight_0), Vec3(0.0f), _S66);
}
...
float transmissiveDiffuseCompensationFactor_0(SurfaceClosure_0 closure_19, float noV_4, float noL_3)
{
    ...
    bool _S67 = (closure_19.thinWalled_1) > 0.5f;
    ...
    return coupled_0 * mix(1.0f, 1.0f / max(max3_0(closureDiffuseEnergy_0(closure_19)), 0.00009999999747379f), sqrt(0.5f * (clamp(sharedF0_0 + _S68 * powf_(1.0f - clamp(noV_4, 0.0f, 1.0f), 5.0f), 0.0f, 1.0f) + clamp(sharedF0_0 + _S68 * powf_(1.0f - clamp(noL_3, 0.0f, 1.0f), 5.0f), 0.0f, 1.0f))));
}
...
Vec3 evalDiffuseReflection_0(SurfaceClosure_0 closure_20, Vec3 normal_8, Vec3 viewDir_7, Vec3 lightDir_7)
{
    ...
    float _S69 = max(dot(normal_8, lightDir_7), 0.0f);

    bool _S70;
    if((closure_20.specular_1) <= 0.00000999999974738f)
    {

        _S70 = (closure_20.transparency_1) <= 0.0f;
    ...
    if(_S70)
    {
        ...
        return closure_20.diffuseReflectionColor_0 * 0.31830987334251404f * _S69;
    }
    float _S71 = max(abs(dot(viewDir_7, normal_8)), 0.0f);

    float factor_1;

    if((closure_20.transparency_1) > 0.0f)
    {
...
bool isThinTransmissiveDielectric_0(SurfaceClosure_0 closure_21)
{
    ...
    if((closure_21.thinWalled_1) > 0.5f)
    {

        if((closure_21.transparency_1) > 0.0f)
        {
        ...
        else
        {
            ...
            _S72 = (closure_21.diffuseTransmissionWeight_0) > 0.0f;
    ...
    if(_S72)
    {
        ...
        _S72 = (closure_21.metallic_1) < 1.0f;
...
Vec3 evaluateThinSharedSpecularGGX_0(SurfaceClosure_0 closure_22, Vec3 normal_9, Vec3 viewDir_8, Vec3 lightDir_8)
{
    ...
    float _S73 = max(dot(normal_9, lightDir_8), 0.0f);
    if(_S73 <= 0.0f)
    {
    ...
    float _S74 = max(dot(viewDir_8, normalize(viewDir_8 + lightDir_8)), 0.0f);
    float _S75 = max(closure_22.roughness_3 * closure_22.roughness_3, 0.0f);



    float eAvg_1 = averageAlbedoGGX_0(_S75);
    float _S76 = 1.0f - eAvg_1;

    float ms_1 = (1.0f - directionalAlbedoGGX_0(_S75, _S73)) * (1.0f - directionalAlbedoGGX_0(_S75, abs(dot(normal_9, viewDir_8)))) / max(3.14159274101257324f * _S76, 9.99999997475242708e-07f);
    ...
    Vec3 f_2;
    if((closure_22.iridescence_2) > 0.00000999999974738f)
    {

        f_2 = thinFilmMixFresnel_0(f_1, thinFilmReflectance_0(1.0f, closure_22.iridescenceIor_2, thinFilmDielectricSubstrateF0_0(closure_22.ior_2, 1.0f), closure_22.iridescenceThickness_2, _S74), closure_22.iridescence_2);
    ...
    return (microfacetResponse_1 * f_2 + ms_1 * (fAvg_1 * fAvg_1 * eAvg_1 / max(Vec3(1.0f) - fAvg_1 * _S76, Vec3(0.00000999999974738f)))) * _S73;
}
...
Vec3 evaluateBaseSpecularGGX_0(SurfaceClosure_0 closure_23, Vec3 normal_10, Vec3 viewDir_9, Vec3 lightDir_9)
{
    ...
    float _S77 = max(dot(viewDir_9, normalize(viewDir_9 + lightDir_9)), 0.0f);
    float _S78 = max(closure_23.roughness_3 * closure_23.roughness_3, 0.0f);

    float eAvg_2 = averageAlbedoGGX_0(_S78);
    float _S79 = 1.0f - eAvg_2;

    float ms_2 = (1.0f - directionalAlbedoGGX_0(_S78, abs(dot(normal_10, lightDir_9)))) * (1.0f - directionalAlbedoGGX_0(_S78, abs(dot(normal_10, viewDir_9)))) / max(3.14159274101257324f * _S79, 9.99999997475242708e-07f);
    Vec3 metalF_0 = fresnelSchlick_0(closure_23.specularColor_1, closure_23.specularF90_0, _S77);
    bool _S80 = (closure_23.iridescence_2) > 0.00000999999974738f;
    ...
    if(_S80)
    {
        ...
        metalF_1 = thinFilmMixFresnel_0(metalF_0, thinFilmReflectance_0(1.0f, closure_23.iridescenceIor_2, closure_23.specularColor_1, closure_23.iridescenceThickness_2, _S77), closure_23.iridescence_2);
    ...
    const Vec3 _S81 = Vec3(1.0f);

    const Vec3 _S82 = Vec3(0.00000999999974738f);
    ...
    if(_S80)
    {
        ...
        dielectricF_1 = thinFilmMixFresnel_0(dielectricF_0, thinFilmReflectance_0(1.0f, closure_23.iridescenceIor_2, thinFilmDielectricSubstrateF0_0(closure_23.ior_2, 1.0f), closure_23.iridescenceThickness_2, _S77), closure_23.iridescence_2);
    ...
    return closure_23.metallic_1 * (metalSingleScatter_0 + metalMultiScatter_0) + closure_23.dielectricWeight_0 * (1.0f - closure_23.transparency_1) * (microfacetResponse_2 * dielectricF_1 + ms_2 * (dielectricFAvg_0 * dielectricFAvg_0 * eAvg_2 / max(_S81 - dielectricFAvg_0 * _S79, _S82)));
}
...
Vec3 evalBaseSpecular_0(SurfaceClosure_0 closure_24, Vec3 normal_11, Vec3 viewDir_10, Vec3 lightDir_10)
{
    ...
    float _S83 = max(dot(normal_11, lightDir_10), 0.0f);
...
float sheenAlpha_0(float roughness_6)
{
    ...
    return max(roughness_6 * roughness_6, 0.0f);
}
...
float sheenLogApprox_0(float x_0, float alpha_21)
{
    ...
    float _S84 = 1.0f - alpha_21;

    float oneMinusAlphaSq_0 = _S84 * _S84;

    return mix(21.54730033874511719f, 25.32449913024902344f, oneMinusAlphaSq_0) / (1.0f + mix(3.82986998558044434f, 3.32435011863708496f, oneMinusAlphaSq_0) * powf_(abs(x_0), mix(0.19822999835014343f, 0.16800999641418457f, oneMinusAlphaSq_0))) + mix(-1.97759997844696045f, -1.27392995357513428f, oneMinusAlphaSq_0) * x_0 + mix(-4.32053995132446289f, -4.85967016220092773f, oneMinusAlphaSq_0);
}
...
float lambdaSheen_0(float cosTheta_8, float alpha_22)
{
    ...
    if((abs(cosTheta_8)) >= 0.5f)
    {

        _S85 = exp(2.0f * sheenLogApprox_0(0.5f, alpha_22) - sheenLogApprox_0(1.0f - cosTheta_8, alpha_22));
...
Vec3 evalSheen_0(SurfaceClosure_0 closure_25, Vec3 normal_12, Vec3 viewDir_11, Vec3 lightDir_11)
{
    ...
    if((max3_0(closure_25.sheenColor_1)) <= 0.0f)
    {

        return Vec3(0.0f);
    }

    float _S86 = max(dot(normal_12, viewDir_11), 0.0f);
    float _S87 = max(dot(normal_12, lightDir_11), 0.0f);
    float _S88 = max(dot(normal_12, normalize(viewDir_11 + lightDir_11)), 0.0f);
    ...
    float invAlpha_0 = 1.0f / max(alpha_23, 0.00000999999974738f);



    return closure_25.sheenColor_1 * (1.0f / (1.0f + lambdaSheen_0(_S86, alpha_23) + lambdaSheen_0(_S87, alpha_23)) * ((2.0f + invAlpha_0) * powf_(abs(max(1.0f - _S88 * _S88, 0.00100000004749745f)), 0.5f * invAlpha_0) / 6.28318548202514648f) / max(4.0f * _S86 * _S87, 0.00000999999974738f)) * _S87;
}
...
float ggxDistribution_0(float alpha_24, float noH_1)
{
    ...
    float d_1 = noH_1 * noH_1 * (a2_0 - 1.0f) + 1.0f;
    return a2_0 / max(3.14159274101257324f * d_1 * d_1, 9.999999960041972e-13f);
}
...
float ggxSmithLambda_0(float alpha_25, float noX_0)
{
    ...
    float _S91 = max(1.0f - _S90, 0.0f);

    bool _S92;
    if(_S91 <= 9.99999993922529029e-09f)
    {
    ...
    else
    {
        ...
        _S92 = cosTheta_9 <= 9.99999993922529029e-09f;
    ...
    return 0.5f * (-1.0f + sqrt(1.0f + alpha_25 * alpha_25 * (_S91 / max(_S90, 9.99999993922529029e-09f))));
}

float ggxSmithG2_0(float alpha_26, float noV_5, float noL_4)
{

    return 1.0f / (1.0f + ggxSmithLambda_0(alpha_26, noV_5) + ggxSmithLambda_0(alpha_26, noL_4));
}
...
Vec3 evaluateMicrofacetGGX_0(Vec3 specularColor_2, Vec3 specularF90_1, float roughness_7, Vec3 normal_13, Vec3 viewDir_13, Vec3 lightDir_13)
{
    ...
    float _S93 = max(dot(normal_13, viewDir_13), 0.0f);
    float _S94 = max(dot(normal_13, lightDir_13), 0.0f);
    float _S95 = max(dot(normal_13, halfVec_2), 0.0f);
    float _S96 = max(dot(viewDir_13, halfVec_2), 0.0f);
    ...
    float _S98 = max(roughness_7 * roughness_7, 0.0f);



    return fresnelSchlick_0(specularColor_2, specularF90_1, _S96) * ggxDistribution_0(_S98, _S95) * ggxSmithG2_0(_S98, _S93, _S94) / max(4.0f * _S93 * _S94, 0.00000999999974738f);
}
...
Vec3 evaluateClearcoatGGX_0(SurfaceClosure_0 closure_26, Vec3 normal_14, Vec3 viewDir_14, Vec3 lightDir_14)
{
    ...
    if((closure_26.clearcoat_2) <= 0.0f)
    {

        return Vec3(0.0f);
    }
    return closure_26.clearcoat_2 * evaluateMicrofacetGGX_0(Vec3(0.03999999910593033f), Vec3(1.0f), closure_26.clearcoatRoughness_1, normal_14, viewDir_14, lightDir_14);
}


Vec3 evalClearcoat_0(SurfaceClosure_0 closure_27, Vec3 normal_15, Vec3 viewDir_15, Vec3 lightDir_15)
{
    return evaluateClearcoatGGX_0(closure_27, normal_15, viewDir_15, lightDir_15) * max(dot(normal_15, lightDir_15), 0.0f);
}
...
float clearcoatBaseWeight_0(SurfaceClosure_0 closure_28, Vec3 clearcoatNormal_0, Vec3 viewDir_16, Vec3 lightDir_16)
{
    ...
    if((closure_28.clearcoat_2) <= 0.0f)
    {
    ...
    const Vec3 _S99 = Vec3(0.03999999910593033f);

    const Vec3 _S100 = Vec3(1.0f);

    return clamp(1.0f - closure_28.clearcoat_2 * max(max3_0(fresnelSchlick_0(_S99, _S100, abs(dot(clearcoatNormal_0, viewDir_16)))), max3_0(fresnelSchlick_0(_S99, _S100, abs(dot(clearcoatNormal_0, lightDir_16))))), 0.0f, 1.0f);
}
...
Vec3 evalMaterialBsdfMixture_0(MaterialBsdfState_0 state_2, Vec3 baseNormal_2, Vec3 clearcoatNormal_1, Vec3 viewDir_17, Vec3 lightDir_17)
{
    ...
    if(!((dot(baseNormal_2, viewDir_17) * dot(baseNormal_2, lightDir_17)) > 0.0f))
    {
    ...
    bool _S101;
    if((state_2.closure_1.thinWalled_1) < 0.5f)
    {

        _S101 = (state_2.closure_1.transparency_1) > 0.0f;
...
float thinInterfaceBaseProbability_0(SurfaceClosure_0 closure_29, float currentMediumIor_4, Vec3 baseNormal_4, Vec3 viewDir_19)
{
    ...
    return clamp(1.0f - max3_0(fresnelSchlick_0(thinSharedSpecularColor_0(closure_29), thinSharedSpecularF90_0(closure_29), max(abs(dot(baseNormal_4, viewDir_19)), 0.00000999999974738f))), 0.0f, 1.0f);
}
...
float transmissiveBaseLayerWeight_0(SurfaceClosure_0 closure_30)
{
    ...
    return max(closure_30.diffuseWeight_0 + closure_30.sheenWeight_0 + closure_30.diffuseTransmissionWeight_0 + closure_30.transmissionWeight_0, 0.00000999999974738f);
}
...
float pdfDiffuseTransmission_0(Vec3 normal_16, Vec3 lightDir_19)
{
    ...
    return max(dot(- normal_16, lightDir_19), 0.0f) * 0.31830987334251404f;
}
...
float sampleSpecularLobePdf_0(SurfaceClosure_0 closure_31, Vec3 normal_17, Vec3 viewDir_20, Vec3 dir_1)
{
    ...
    float _S102 = max(dot(viewDir_20, halfVec_3), 0.0f);
    ...
    return ggxDistributionAnisotropic_0(anisotropicAlpha_0(closure_31.roughness_3, closure_31.anisotropy_1), localHalf_2) * noH_2 / max(4.0f * _S102, 0.00000999999974738f);
}
...
float ggxSmithG1Anisotropic_0(Vec2 alpha_27, Vec3 localDir_1)
{
    ...
    return 1.0f / (1.0f + ggxSmithLambdaAnisotropic_0(alpha_27, localDir_1));
}
...
float evaluateThickTransmissionPdf_0(SurfaceClosure_0 closure_32, Vec3 normal_18, Vec3 viewDir_21, Vec3 lightDir_20, float iorI_6, float iorO_6)
{
    ...
    else
    {
        ...
        _S104 = noL_5 <= 0.00000999999974738f;
    ...
    else
    {
        ...
        _S104 = (dot(normal_18, viewDir_21) * dot(normal_18, lightDir_20)) >= 0.0f;
    ...
    float etaRatio_1 = iorO_6 / max(iorI_6, 0.00000999999974738f);
    ...
    if((abs(localHalf_3.z)) <= 0.00000999999974738f)
    {
    ...
    return ggxDistributionAnisotropic_0(alpha_28, localHalf_3) * ggxSmithG1Anisotropic_0(alpha_28, localView_3) * (etaRatio_1 * etaRatio_1 * abs(voH_1) * abs(loH_1) / max(powf_(voH_1 + etaRatio_1 * loH_1, 2.0f) * noV_6, 0.00000999999974738f));
}
...
float pdfDielectricTransmission_0(SurfaceClosure_0 closure_33, float currentMediumIor_5, Vec3 normal_19, Vec3 viewDir_22, Vec3 lightDir_21)
{
    ...
    float _S105 = max(currentMediumIor_5, 1.0f);

    bool insideMedium_2;
    if(_S105 > 1.00010001659393311f)
    {

        insideMedium_2 = (closure_33.thinWalled_1) < 0.5f;
    ...
    if((dot(normal_19, viewDir_22) * dot(normal_19, lightDir_21)) < 0.0f)
    {

        float _S106 = max(coeffs_2.transmissionProb_0, 0.00000999999974738f);

        float lobePdf_0;

        if((closure_33.thinWalled_1) > 0.5f)
        {
        ...
        return max(_S106 * lobePdf_0, 0.00000999999974738f);
    }


    return max(clamp(coeffs_2.reflectionProb_0, 0.0f, 1.0f) * sampleSpecularLobePdf_0(closure_33, normal_19, viewDir_22, lightDir_21), 0.00000999999974738f);
}
...
float pdfDiffuseReflection_0(Vec3 normal_20, Vec3 lightDir_22)
{
    ...
    return max(dot(normal_20, lightDir_22), 0.0f) * 0.31830987334251404f;
}
...
float pdfSheen_0(Vec3 normal_21, Vec3 lightDir_23)
{
    ...
    return max(dot(normal_21, lightDir_23), 0.0f) * 0.31830987334251404f;
}
...
float sampleSpecularLobePdfIsotropic_0(Vec3 normal_23, Vec3 viewDir_24, float roughness_8, Vec3 dir_2)
{
    ...
    float _S107 = max(dot(normal_23, halfVec_5), 0.0f);
    float _S108 = max(dot(viewDir_24, halfVec_5), 0.0f);
    ...
    return ggxDistribution_0(max(roughness_8 * roughness_8, 0.0f), _S107) * _S107 / max(4.0f * _S108, 0.00000999999974738f);
}
...
float pdfClearcoat_0(SurfaceClosure_0 closure_35, Vec3 normal_24, Vec3 viewDir_25, Vec3 lightDir_25)
{
    ...
    if((max(dot(normal_24, lightDir_25), 0.0f)) > 0.0f)
    {
...
{
    return max3_0(fresnelSchlick_0(closure_36.dielectricSpecularColor_0, closure_36.dielectricSpecularF90_0, max(dot(baseNormal_5, viewDir_26), 0.0f)));
}
...
float pdfMaterialBsdfMixture_0(MaterialBsdfState_0 state_5, Vec3 baseNormal_6, Vec3 clearcoatNormal_3, Vec3 viewDir_27, Vec3 dir_3)
{
    ...
    float _S112 = max(_S111, 0.0f);
    float _S113 = max(dot(clearcoatNormal_3, dir_3), 0.0f);
    bool transmissionSide_0 = (dot(baseNormal_6, viewDir_27) * _S111) < 0.0f;
    ...
    if(thinDielectric_0)
    {
        ...
        thinSpecularProb_0 = 1.0f - thinBaseProb_0;

    }
    else
    {

        thinSpecularProb_0 = 0.0f;
    ...
    if(transmissionSide_0)
    {
        ...
        if(thinDielectric_0)
        {
            ...
            if((state_5.closure_1.diffuseTransmissionWeight_0) > 0.0f)
            {
            ...
            if((state_5.closure_1.transmissionWeight_0) > 0.0f)
            {
            ...
            if(pdf_0 > 0.0f)
            {
                ...
                thinBaseProb_0 = max(pdf_0, 0.00000999999974738f);
        ...
        float _S114 = max(state_5.closure_1.diffuseTransmissionWeight_0 + state_5.closure_1.transmissionWeight_0, 0.00000999999974738f);
    ...
    if(thinDielectric_0)
    {
        ...
        float _S115 = max(thinBaseProb_0 + thinSpecularProb_0 + state_5.closure_1.clearcoatWeight_0, 0.00000999999974738f);
        ...
        return max(diffusePdf_0 + sheenPdf_0 + specularPdf_0 + _S116 * thinBaseProb_0, 0.00000999999974738f);
    }

    float dielectricViewFresnel_0 = dielectricViewFresnelMax_0(state_5.closure_1, baseNormal_6, viewDir_27);
    float _S117 = 1.0f - dielectricViewFresnel_0;
    ...
    float specularProbWeight_0 = state_5.closure_1.specularWeight_0 + state_5.closure_1.dielectricWeight_0 * (1.0f - state_5.closure_1.transparency_1) * dielectricViewFresnel_0;
    float _S118 = max(diffuseProbWeight_0 + sheenProbWeight_0 + state_5.closure_1.diffuseTransmissionWeight_0 + specularProbWeight_0 + state_5.closure_1.transmissionWeight_0 + state_5.closure_1.clearcoatWeight_0, 0.00000999999974738f);
    ...
    return max(diffusePdf_1 + sheenPdf_1 + specularPdf_1 + pdf_0 + _S119 * thinBaseProb_0, 0.00000999999974738f);
}
...
void orthonormalBasis_0(Vec3 n_1, Vec3& tangent_2, Vec3& bitangent_0)
{
    ...
    float a_0 = -1.0f / (sign_0 + _S120);
    float _S121 = n_1.x;

    float _S122 = n_1.y;

    float b_0 = _S121 * _S122 * a_0;
    tangent_2 = normalize(Vec3(1.0f + sign_0 * _S121 * _S121 * a_0, sign_0 * b_0, - sign_0 * _S121));
...
Vec3 sampleCosineHemisphere_0(Vec3 normal_25, float u0_0, float u1_0)
{
    ...
    float r_0 = sqrt(u0_0);
    float phi_0 = 6.28318548202514648f * u1_0;
    float _S123 = r_0 * cos(phi_0);

    float _S124 = r_0 * sin(phi_0);

    float _S125 = sqrt(max(0.0f, 1.0f - u0_0));
    Vec3 tangent_3;
    Vec3 bitangent_1;
...
BsdfSample_0 sampleDiffuseReflection_0(SurfaceClosure_0 closure_37, float currentMediumIor_6, Vec3 normal_26, Vec3 viewDir_28, float u0_1, float u1_1)
{
    ...
    float _S126 = max(pdfDiffuseReflection_0(normal_26, dir_4), 0.00000999999974738f);
    ...
    sample_0.specular_2 = 0.0f;
    sample_0.crossedBoundary_0 = 0.0f;
...
BsdfSample_0 sampleSheen_0(SurfaceClosure_0 closure_38, float currentMediumIor_7, Vec3 normal_27, Vec3 viewDir_29, float u0_2, float u1_2)
{
    ...
    float _S127 = max(pdfSheen_0(normal_27, dir_5), 0.00000999999974738f);
    ...
    sample_1.specular_2 = 0.0f;
    sample_1.crossedBoundary_0 = 0.0f;
...
BsdfSample_0 sampleDiffuseTransmission_0(SurfaceClosure_0 closure_39, float currentMediumIor_8, Vec3 normal_28, Vec3 viewDir_30, float u0_3, float u1_3)
{
    ...
    float _S128 = max(pdfDiffuseTransmission_0(normal_28, dir_6), 0.00000999999974738f);

    bool insideMedium_3;
    if((max(currentMediumIor_8, 1.0f)) > 1.00010001659393311f)
    {

        insideMedium_3 = (closure_39.thinWalled_1) < 0.5f;
    ...
    sample_2.specular_2 = 0.0f;
    bool _S129 = (closure_39.thinWalled_1) < 0.5f;
...
void anisotropicBasis_0(Vec3 normal_29, Vec3 tangentInput_0, Vec3& tangent_4, Vec3& bitangent_2)
{
...
Vec3 sampleGGXHalfVector_0(SurfaceClosure_0 closure_40, Vec3 normal_30, float roughness_9, float u0_4, float u1_4)
{
    ...
    float phi_1 = 6.28318548202514648f * u1_4;
    ...
    float cosTheta_10 = 1.0f / sqrt(1.0f + u0_4 / max(1.0f - u0_4, 9.99999997475242708e-07f) / max(cosPhi_0 * cosPhi_0 / max(_S132 * _S132, 9.999999960041972e-13f) + sinPhi_0 * sinPhi_0 / max(_S133 * _S133, 9.999999960041972e-13f), 9.99999997475242708e-07f));
    float sinTheta_0 = sqrt(max(0.0f, 1.0f - cosTheta_10 * cosTheta_10));
...
Vec3 dispersionChannelMask_0(float channelU_0)
{
    ...
    if(channelU_0 < 0.3333333432674408f)
    {

        return Vec3(1.0f, 0.0f, 0.0f);
    }
    if(channelU_0 < 0.66666668653488159f)
    {
...
Vec3 safeRefract_0(Vec3 incident_0, Vec3 normal_32, float eta_1)
{
    ...
    float k_0 = 1.0f - eta_1 * eta_1 * (1.0f - noI_0 * noI_0);
    if(k_0 <= 0.0f)
    {
...
BsdfSample_0 sampleDielectricTransmission_0(SurfaceClosure_0 closure_42, float currentMediumIor_9, Vec3 transmissionNormal_1, Vec3 normal_33, Vec3 viewDir_31, float u0_5, float u1_5, float eventU_0)
{
    ...
    float _S136 = max(currentMediumIor_9, 1.0f);

    bool insideMedium_4;
    if(_S136 > 1.00010001659393311f)
    {

        insideMedium_4 = (closure_42.thinWalled_1) < 0.5f;
    ...
    bool _S137;
    if((closure_42.thinWalled_1) < 0.5f)
    {

        _S137 = (abs(iorI_8 - iorO_8)) <= 0.00009999999747379f;
    ...
    if(_S137)
    {
        ...
        nullSample_0.pdf_1 = 1.0f;
        nullSample_0.bsdfOverPdf_0 = weightedTransmissionColor_1(closure_42);
        nullSample_0.specular_2 = 2.0f;
        nullSample_0.crossedBoundary_0 = 1.0f;
    ...
    float probReflect_0 = clamp(coeffs_3.reflectionProb_0, 0.0f, 1.0f);
    float _S138 = max(coeffs_3.transmissionProb_0, 0.00000999999974738f);

    BsdfSample_0 sample_3;
    sample_3.crossedBoundary_0 = 0.0f;
    sample_3.nextMediumIor_0 = currentMediumIor_9;
    if(eventU_0 <= probReflect_0)
    {

        Vec3 dir_7 = reflect(- viewDir_31, halfVec_7);
        float lobePdf_1 = halfPdf_0 / max(4.0f * abs(dot(dir_7, halfVec_7)), 0.00000999999974738f);
        sample_3.direction_0 = dir_7;
        float _S139 = max(probReflect_0 * lobePdf_1, 0.00000999999974738f);
    ...
    if((closure_42.thinWalled_1) > 0.5f)
    {
        ...
        float lobePdf_2 = halfPdf_0 / max(4.0f * abs(dot(dir_8, halfVec_7)), 0.00000999999974738f);
        sample_3.direction_0 = dir_8;
        float _S140 = max(_S138 * lobePdf_2, 0.00000999999974738f);
    ...
    bool _S141 = (closure_42.dispersion_2) > 0.00000999999974738f;
    float channelU_1 = clamp((eventU_0 - probReflect_0) / max(_S138, 0.00000999999974738f), 0.0f, 0.99999898672103882f);
    ...
    if(_S141)
    {
        ...
        channelProb_0 = 0.3333333432674408f;
    ...
    Vec3 refracted_0 = safeRefract_0(_S142, halfVec_7, sampleIorI_0 / max(sampleIorO_0, 0.00000999999974738f));
    if((length(refracted_0)) <= 0.00000999999974738f)
    {

        Vec3 dir_9 = reflect(_S142, halfVec_7);
        float _S143 = max(pdfDielectricTransmission_0(closure_42, currentMediumIor_9, normal_33, viewDir_31, dir_9), 0.00000999999974738f);
    ...
    float lobePdf_3 = halfPdf_0 * (sampleIorO_0 * sampleIorO_0) * abs(_S145) / max(powf_(sampleIorI_0 * _S144 + sampleIorO_0 * _S145, 2.0f), 0.00000999999974738f);
    ...
    if((closure_42.iridescence_2) > 0.00000999999974738f)
    {

        _S137 = iorI_8 <= 1.00010001659393311f;
    ...
    if(_S137)
    {
        ...
        effectiveTransmissionCoeff_1 = (Vec3(1.0f) - thinFilmDielectricFresnel_0(closure_42, _S146, regularReflect_2, 1.0f)) * weightedTransmissionColor_1(closure_42);
    ...
    sample_3.pdf_1 = max(_S147 * lobePdf_3, 0.00000999999974738f);
    sample_3.bsdfOverPdf_0 = effectiveTransmissionCoeff_1 * channelMask_0 / max(_S147, 0.00000999999974738f) * g1Light_0;
    sample_3.specular_2 = 1.0f;
    sample_3.crossedBoundary_0 = 1.0f;
    if(insideMedium_4)
    {
...
BsdfSample_0 sampleBaseSpecular_0(SurfaceClosure_0 closure_43, float currentMediumIor_10, Vec3 normal_34, Vec3 viewDir_32, float u0_6, float u1_6)
{
    ...
    {
        Vec3 _H = normalize(viewDir_32 + dir_10);
        if (dot(viewDir_32, _H) <= 0.0f) {
            BsdfSample_0 _ns;
            _ns.direction_0 = dir_10;
            _ns.pdf_1 = 0.0f;
            _ns.bsdfOverPdf_0 = Vec3(0.0f);
            _ns.specular_2 = 0.0f;
            _ns.crossedBoundary_0 = 0.0f;
            _ns.nextMediumIor_0 = currentMediumIor_10;
            return _ns;
        }
    }
    float _S148 = max(pdfBaseSpecular_0(closure_43, normal_34, viewDir_32, dir_10), 0.00000999999974738f);
    ...
    sample_4.specular_2 = 1.0f;
    sample_4.crossedBoundary_0 = 0.0f;
...
Vec3 sampleGGXHalfVectorIsotropic_0(Vec3 normal_35, float roughness_10, float u0_7, float u1_7)
{
    ...
    float _S149 = max(roughness_10 * roughness_10, 0.0f);

    float phi_2 = 6.28318548202514648f * u1_7;
    float cosTheta_11 = sqrt((1.0f - u0_7) / max(1.0f + (_S149 * _S149 - 1.0f) * u0_7, 9.99999997475242708e-07f));
    float sinTheta_1 = sqrt(max(0.0f, 1.0f - cosTheta_11 * cosTheta_11));
...
BsdfSample_0 sampleClearcoat_0(SurfaceClosure_0 closure_44, float currentMediumIor_11, Vec3 normal_36, Vec3 viewDir_33, float u0_8, float u1_8)
{
    ...
    {
        Vec3 _H = normalize(viewDir_33 + dir_11);
        if (dot(viewDir_33, _H) <= 0.0f) {
            BsdfSample_0 _ns;
            _ns.direction_0 = dir_11;
            _ns.pdf_1 = 0.0f;
            _ns.bsdfOverPdf_0 = Vec3(0.0f);
            _ns.specular_2 = 0.0f;
            _ns.crossedBoundary_0 = 0.0f;
            _ns.nextMediumIor_0 = currentMediumIor_11;
            return _ns;
        }
    }
    float _S152 = max(pdfClearcoat_0(closure_44, normal_36, viewDir_33, dir_11), 0.00000999999974738f);
    ...
    sample_5.specular_2 = 1.0f;
    sample_5.crossedBoundary_0 = 0.0f;
...
BsdfSample_0 sampleMaterialBsdfMixture_0(MaterialBsdfState_0 state_8, Vec3 rawGeometryNormal_1, Vec3 transmissionNormal_2, Vec3 baseNormal_7, Vec3 clearcoatNormal_4, Vec3 viewDir_34, float choiceU_0, float u0_9, float u1_9, float eventU_1)
{
    ...
    if(isThinTransmissiveDielectric_0(state_8.closure_1))
    {
        ...
        float thinSpecularProb_1 = 1.0f - thinBaseProb_1;
        float baseLayerWeight_2 = transmissiveBaseLayerWeight_0(state_8.closure_1);
        float _S153 = max(thinBaseProb_1 + thinSpecularProb_1 + state_8.closure_1.clearcoatWeight_0, 0.00000999999974738f);
        ...
        thinSample_0.crossedBoundary_0 = 0.0f;
            ...
            else
            {
                ...
                else
                {
                    ...
                    if(choiceU_0 < _S156)
                    {
                        ...
                        thinSample_0 = sampleDielectricTransmission_0(state_8.closure_1, state_8.currentMediumIor_0, transmissionNormal_2, baseNormal_7, viewDir_34, u0_9, u1_9, 1.0f);
                        ...
                        thinSample_0.bsdfOverPdf_0 = evalDielectricTransmission_0(state_8.closure_1, state_8.currentMediumIor_0, baseNormal_7, viewDir_34, thinSample_0.direction_0) / max(_S157, 0.00000999999974738f);
        ...
        float _S159 = max(_S158, 0.0f);
        float _S160 = max(dot(clearcoatNormal_4, thinDir_0), 0.0f);
        bool transmissionSide_1 = _S158 < 0.0f;
        if(_S159 <= 0.0f)
        {
            ...
            if(transmissionSide_1)
            {
                ...
                float _S161 = max(mixPdf_0, 0.00000999999974738f);

                thinSample_0.pdf_1 = _S161;
                thinSample_0.bsdfOverPdf_0 = diffuseTransmissionEval_0 / max(_S161, 0.00000999999974738f);
                thinSample_0.specular_2 = 0.0f;
                return thinSample_0;
            }
            Vec3 fallbackDir_0 = sampleCosineHemisphere_0(baseNormal_7, u0_9, u1_9);
            float _S162 = max(dot(baseNormal_7, fallbackDir_0), 0.0f);
            thinSample_0.direction_0 = fallbackDir_0;
            thinSample_0.pdf_1 = max(_S162 * 0.31830987334251404f, 0.00000999999974738f);
            thinSample_0.bsdfOverPdf_0 = Vec3(0.0f);
            thinSample_0.specular_2 = 0.0f;
            return thinSample_0;
        }

        float mixPdf_1 = pdfMaterialBsdfMixture_0(state_8, baseNormal_7, clearcoatNormal_4, viewDir_34, thinDir_0);
        Vec3 reflectedBaseEval_0 = evaluateReflectedBaseScattering_0(state_8, baseNormal_7, viewDir_34, thinDir_0) / max(_S159, 0.00000999999974738f);
        if(_S160 > 0.0f)
        {

            clearcoatEval_0 = evalClearcoat_0(state_8.closure_1, clearcoatNormal_4, viewDir_34, thinDir_0) / max(_S160, 0.00000999999974738f);

        }
        else
        {

            clearcoatEval_0 = Vec3(0.0f);
        ...
        thinSample_0.bsdfOverPdf_0 = (reflectedBaseEval_0 * baseWeight_0 + clearcoatEval_0) * _S159 / max(mixPdf_1, 0.00000999999974738f);
        return thinSample_0;
    }

    float dielectricViewFresnel_1 = dielectricViewFresnelMax_0(state_8.closure_1, baseNormal_7, viewDir_34);
    float _S163 = 1.0f - dielectricViewFresnel_1;
    ...
    float specularProbWeight_1 = state_8.closure_1.specularWeight_0 + state_8.closure_1.dielectricWeight_0 * (1.0f - state_8.closure_1.transparency_1) * dielectricViewFresnel_1;
    float baseProbWeight_0 = diffuseProbWeight_1 + sheenProbWeight_1 + state_8.closure_1.diffuseTransmissionWeight_0;
    float _S164 = max(baseProbWeight_0 + specularProbWeight_1 + state_8.closure_1.transmissionWeight_0 + state_8.closure_1.clearcoatWeight_0, 0.00000999999974738f);
    ...
    sample_6.crossedBoundary_0 = 0.0f;
    sample_6.nextMediumIor_0 = state_8.currentMediumIor_0;
    if(choiceU_0 < baseProb_0)
    {

        float baseChoiceU_0 = choiceU_0 / max(baseProb_0, 0.00000999999974738f);
        bool _S165 = baseProbWeight_0 > 0.0f;
    ...
    else
    {
        ...
        else
        {
            ...
            if(choiceU_0 < (_S166 + transmissionProb_1))
            {
                ...
                sample_6.bsdfOverPdf_0 = sample_6.bsdfOverPdf_0 / max(transmissionProb_1, 0.00000999999974738f);
                if((sample_6.pdf_1) < 1.0f)
                {
    ...
    float _S169 = max(_S168, 0.0f);
    float _S170 = max(dot(clearcoatNormal_4, thinDir_0), 0.0f);
    bool transmissionSide_2 = _S168 < 0.0f;
    ...
    if(_S169 <= 0.0f)
    {
        ...
        if(transmissionSide_2)
        {
            ...
            float _S171 = max(mixPdf_2, 0.00000999999974738f);

            sample_6.pdf_1 = _S171;
            sample_6.bsdfOverPdf_0 = diffuseTransmissionEval_1 / _S171;
            sample_6.specular_2 = 0.0f;
            return sample_6;
        }
        Vec3 fallbackDir_1 = sampleCosineHemisphere_0(baseNormal_7, u0_9, u1_9);
        float _S172 = max(dot(baseNormal_7, fallbackDir_1), 0.0f);
        sample_6.direction_0 = fallbackDir_1;
        sample_6.pdf_1 = max(_S172 * 0.31830987334251404f, 0.00000999999974738f);
        sample_6.bsdfOverPdf_0 = Vec3(0.0f);
        sample_6.specular_2 = 0.0f;
        sample_6.nextMediumIor_0 = state_8.currentMediumIor_0;
        return sample_6;
    }
    ...
    Vec3 reflectedBaseEval_1 = evaluateReflectedBaseScattering_0(state_8, baseNormal_7, viewDir_34, thinDir_0) / max(_S169, 0.00000999999974738f);
    if(_S170 > 0.0f)
    {

        clearcoatEval_0 = evalClearcoat_0(state_8.closure_1, clearcoatNormal_4, viewDir_34, thinDir_0) / max(_S170, 0.00000999999974738f);
...
{
    return multiscatterColor_2 * 0.0f + Vec3(scatterAnisotropy_3 * 0.0f);
}
...
MaterialVolumeState_0 buildVolumeCoefficients_0(SurfaceClosure_0 closure_45)
{
    ...
    volume_0.sigmaT_0 = - log(max(closure_45.attenuationColor_2, Vec3(0.00009999999747379f))) / max(closure_45.attenuationDistance_2, 0.00009999999747379f);

    float _S173;
    if((closure_45.thinWalled_1) < 0.5f)
    {
    ...
    volume_0.scatterAnisotropy_4 = 0.0f;


    Vec3 _S174 = multiscatterToSingleScatterAlbedo_0(closure_45.multiscatterColor_1, 0.0f);

    volume_0.rhoSs_0 = _S174;
    volume_0.sigmaA_0 = max(volume_0.sigmaT_0 * (Vec3(1.0f) - _S174), Vec3(0.0f));
    volume_0._pad0_1 = 0.0f;
    return volume_0;
}
...
Vec3 evalHomogeneousTransmittance_0(MaterialVolumeState_0 volume_1, float distance_0)
{
    ...
    return exp(- max(volume_1.sigmaT_0, Vec3(0.0f)) * max(distance_0, 0.0f));
}
...
float homogeneousMediumNoEventPdf_0(MaterialVolumeState_0 volume_5, float distance_4)
{
    ...
    return max((tr_0.x + tr_0.y + tr_0.z) / 3.0f, 0.00000999999974738f);
}
...
MaterialVolumeState_0 clearMaterialVolumeState_0()
{
    ...
    const Vec3 _S175 = Vec3(0.0f);

    volume_7.sigmaT_0 = _S175;
    volume_7.rhoSs_0 = _S175;
    volume_7.sigmaA_0 = _S175;
    volume_7.scatterAnisotropy_4 = 0.0f;
    volume_7._pad0_1 = 0.0f;
    volume_7.isActive_0 = 0.0f;
    return volume_7;
}
...
PbrGltfState pbrPrepareStateFromGltf(PbrGltfMaterial material, PbrClosure closure, PbrTransport transport)
{
    ...
    stable.currentMediumIor = max(transport.currentMediumIor, 1.0f);
    return stable;
}
